...
> **See [`references/azure-integration.md`](references/azure-integration.md)** for Azure Key Vault setup, Service Principal authentication, and full automation script template.
...
> **See [`references/azure-integration.md`](references/azure-integration.md)** for Service Principal credential storage and authentication.
