...
For day-to-day ZFS pool and dataset management (layouts, properties,
replication, health) see the dedicated [`linux-zfs`](../linux-zfs/SKILL.md)
skill — this section covers snapshots only.
