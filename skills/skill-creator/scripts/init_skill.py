...
# Optional frontmatter fields (Agent Skills spec):
# license: MIT
# compatibility: Requires Windows 11 and PowerShell 7+ (only if environment-specific)
# metadata:
#   author: your-name
#   version: "0.1.0"
---
...
def main():
    ...
    result = init_skill(skill_name, path, resources, args.examples, None)
